...
- **data_sim.R**: The function ``data_sim()`` is used to simulate continuous or binary data for two-stage platform trial, based on given sample sizes, effect sizes and time trend specifications.
...
- **allinone_sim_par.R**: The function ``allinone_simsce_par()`` is a parallel version of ``allinone_simsce()``
