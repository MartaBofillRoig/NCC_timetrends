---
title: "Simulation non-concurrent control data"
author: ""
date: "`r Sys.Date()`"
output: 
  html_document:
...
ggarrange(ggplot(get_data_plot(results_bin_eq) %>% filter(model!="zsep" & model!="zpol" & hypothesis %in% c("H0", "H0_1"))) +
          ...
          ggplot(get_data_plot(results_bin_eq) %>% filter(model!="zsep" & model!="zpol" & hypothesis %in% c("H1", "H1_1"))) +
            #geom_point(aes(lambda1, reject_h02, color=as.factor(model))) +
            geom_line(aes(lambda1, reject_h02, color=as.factor(model)), size=1) +
            geom_hline(aes(yintercept = alpha), linetype = "dashed") +
            facet_grid(trend ~ hypothesis, scales = "free", 
            ...
            theme_bw() +
            theme(legend.position = "bottom") +
            labs(x=TeX("$\\lambda$"), color="Analysis approach:", y="Power") +
            scale_color_manual(values = my_palette, labels = c("ALLTC-Linear", "ALLTCI-Linear", "ALLTC-Step", "ALLTCI-Step", "TC-Linear", "TC-Step", "Pooled approach", "Separate approach")),
          common.legend = T, legend = "bottom")



ggsave("figures_transposed/bin_all_eq_pow_alpha_supp_t.png", width = 9, height = 10)
```

## Bias

```{r, fig.width=9, fig.height=10}
hypothesis_names <- c(H0="Null hypothesis (OR1<1)", H1="Alternative hypothesis (OR1<1)", H0_1="Null hypothesis (OR1>1)", H1_1="Alternative hypothesis (OR1>1)")
trend_names <- c(linear = "Linear", stepwise = "Stepwise", inv_u_1 = "Inverted-U (N[p] == 125)", inv_u_2 = "Inverted-U (N[p] == 250)", inv_u_3 = "Inverted-U (N[p] == 500)")
...
ggsave("figures_transposed/bin_all_eq_bias_supp_t.png", width = 9, height = 10)
```
...
ggsave("figures_transposed/bin_all_eq_rmse_supp_t.png", width = 9, height = 10)
```
...
ggplot(get_data_plot_prob_1(results_bin_diff_step_1) %>% filter(model %in% c("a2", "a2_int", "log_sep", "log_pol"), scenario=="mult_pos")) +
  ...
  labs(color="") +
  geom_hline(aes(yintercept = alpha), linetype = "dashed") +
  facet_grid(OR_1 ~ hypothesis_1, scales = "free", 
             labeller = labeller(hypothesis_1  = as_labeller(hypothesis_1_names),
                                 OR_1  = as_labeller(OR1_names))) +
  theme_bw() +
  theme(legend.position = "bottom")

ggsave("figures_transposed/bin_step_diff_pos_pow_alpha_main_t.png", width = 10, height = 6)
```
...
ggsave("figures_transposed/bin_step_diff_pos_pow_alpha_supp_t.png", width = 10, height = 6)
```
...
ggsave("figures_transposed/bin_step_diff_neg_pow_alpha_supp_t.png", width = 10, height = 6)
```
...
ggarrange(ggplot(get_data_plot(results_bin_diff) %>% filter(model %in% c("a2", "a2_int", "log_sep", "log_pol"), scenario=="mult_pos", trend %in% c("linear", "stepwise", "inv_u_3"), hypothesis %in% c("H0", "H0_1"))) +
            #geom_point(aes(lambda1, reject_h02, color=as.factor(model))) +
            geom_line(aes(lambda1, reject_h02, color=as.factor(model)), size=1) +
            geom_hline(aes(yintercept = alpha), linetype = "dashed") +
            facet_grid(trend ~ hypothesis, scales = "free", 
            ...
            theme_bw() +
            theme(legend.position = "bottom") +
            labs(x=TeX("$\\lambda_1$"), color="Analysis approach:", y="Type I error") +
            scale_color_manual(values = my_palette, labels = c("ALLTC-Step", "ALLTCI-Step", "Pooled approach", "Separate approach")),
          
          ggplot(get_data_plot(results_bin_diff) %>% filter(model %in% c("a2", "a2_int", "log_sep", "log_pol"), scenario=="mult_pos", trend %in% c("linear", "stepwise", "inv_u_3"), hypothesis %in% c("H1", "H1_1"))) +
            #geom_point(aes(lambda1, reject_h02, color=as.factor(model))) +
            geom_line(aes(lambda1, reject_h02, color=as.factor(model)), size=1) +
            geom_hline(aes(yintercept = alpha), linetype = "dashed") +
            facet_grid(trend ~ hypothesis, scales = "free", 
            ...
            theme_bw() +
            theme(legend.position = "bottom") +
            labs(x=TeX("$\\lambda_1$"), color="Analysis approach:", y="Power") +
            scale_color_manual(values = my_palette, labels = c("ALLTC-Step", "ALLTCI-Step", "Pooled approach", "Separate approach")),
          
          common.legend = T, legend = "bottom")

ggsave("figures_transposed/bin_all_diff_pos_pow_alpha_main_t.png", width = 10, height = 10)
```
...
ggarrange(ggplot(get_data_plot(results_bin_diff) %>% filter(model!="zsep" & model!="zpol", scenario=="mult_pos", hypothesis %in% c("H0", "H0_1"))) +
            #geom_point(aes(lambda1, reject_h02, color=as.factor(model))) +
            geom_line(aes(lambda1, reject_h02, color=as.factor(model)), size=1) +
            geom_hline(aes(yintercept = alpha), linetype = "dashed") +
            facet_grid(trend ~ hypothesis, scales = "free", 
          ...
          ggplot(get_data_plot(results_bin_diff) %>% filter(model!="zsep" & model!="zpol", scenario=="mult_pos", hypothesis %in% c("H1", "H1_1"))) +
            #geom_point(aes(lambda1, reject_h02, color=as.factor(model))) +
            geom_line(aes(lambda1, reject_h02, color=as.factor(model)), size=1) +
            geom_hline(aes(yintercept = alpha), linetype = "dashed") +
            facet_grid(trend ~ hypothesis, scales = "free", 
...
ggsave("figures_transposed/bin_all_diff_pos_pow_alpha_supp_t.png", width = 9, height = 10)
```
...
ggarrange(ggplot(get_data_plot(results_bin_diff) %>% filter(model!="zsep" & model!="zpol", scenario=="mult_neg", hypothesis %in% c("H0", "H0_1"))) +
            #geom_point(aes(lambda1, reject_h02, color=as.factor(model))) +
            geom_line(aes(lambda1, reject_h02, color=as.factor(model)), size=1) +
            geom_hline(aes(yintercept = alpha), linetype = "dashed") +
            facet_grid(trend ~ hypothesis, scales = "free", 
          ...
          ggplot(get_data_plot(results_bin_diff) %>% filter(model!="zsep" & model!="zpol", scenario=="mult_neg", hypothesis %in% c("H1", "H1_1"))) +
            #geom_point(aes(lambda1, reject_h02, color=as.factor(model))) +
            geom_line(aes(lambda1, reject_h02, color=as.factor(model)), size=1) +
            geom_hline(aes(yintercept = alpha), linetype = "dashed") +
            facet_grid(trend ~ hypothesis, scales = "free", 
...
ggsave("figures_transposed/bin_all_diff_neg_pow_alpha_supp_t.png", width = 9, height = 10)
```
...
ggsave("figures_transposed/bin_all_diff_pos_bias_supp_t.png", width = 9, height = 10)
```
...
ggsave("figures_transposed/bin_all_diff_pos_rmse_supp_t.png", width = 9, height = 10)
```
...
ggarrange(ggplot(get_data_plot(results_cont_eq) %>% filter(model!="zsep" & model!="zpol", hypothesis=="H0")) +
            #geom_point(aes(lambda1, reject_h02, color=as.factor(model))) +
            geom_line(aes(lambda1, reject_h02, color=as.factor(model)), size=1) +
            geom_hline(aes(yintercept = alpha), linetype = "dashed") +
            facet_grid(trend ~ hypothesis, scales = "free", 
          ...
          ggplot(get_data_plot(results_cont_eq) %>% filter(model!="zsep" & model!="zpol", hypothesis=="H1")) +
            #geom_point(aes(lambda1, reject_h02, color=as.factor(model))) +
            geom_line(aes(lambda1, reject_h02, color=as.factor(model)), size=1) +
            geom_hline(aes(yintercept = alpha), linetype = "dashed") +
            facet_grid(trend ~ hypothesis, scales = "free", 
...
ggsave("figures_transposed/cont_all_eq_pow_alpha_supp_t.png", width = 7, height = 10)
```
...
ggsave("figures_transposed/cont_all_eq_bias_supp_t.png", width = 7, height = 10)
```
...
ggsave("figures_transposed/cont_all_eq_rmse_supp_t.png", width = 7, height = 10)
```
...
ggsave("figures_transposed/cont_step_diff_pow_alpha_main_t.png", width = 7, height = 6)
```
...
ggarrange(ggplot(get_data_plot(results_cont_diff) %>% filter(model %in% c("a2", "a2_int", "tsep", "tpol"), trend %in% c("linear", "stepwise", "inv_u_3"), hypothesis=="H0")) +
  #geom_point(aes(lambda1, reject_h02, color=as.factor(model))) +
  geom_line(aes(lambda1, reject_h02, color=as.factor(model)), size=1) +
  geom_hline(aes(yintercept = alpha), linetype = "dashed") +
  facet_grid(trend ~ hypothesis, scales = "free", 
  ...
  ggplot(get_data_plot(results_cont_diff) %>% filter(model %in% c("a2", "a2_int", "tsep", "tpol"), trend %in% c("linear", "stepwise", "inv_u_3"), hypothesis=="H1")) +
  #geom_point(aes(lambda1, reject_h02, color=as.factor(model))) +
  geom_line(aes(lambda1, reject_h02, color=as.factor(model)), size=1) +
  geom_hline(aes(yintercept = alpha), linetype = "dashed") +
  facet_grid(trend ~ hypothesis, scales = "free", 
...
ggsave("figures_transposed/cont_all_diff_pow_alpha_main_t.png", width = 7, height = 10)
```
...
ggarrange(ggplot(get_data_plot(results_cont_diff) %>% filter(model!="zsep" & model!="zpol", hypothesis=="H0")) +
            #geom_point(aes(lambda1, reject_h02, color=as.factor(model))) +
            geom_line(aes(lambda1, reject_h02, color=as.factor(model)), size=1) +
            geom_hline(aes(yintercept = alpha), linetype = "dashed") +
            facet_grid(trend ~ hypothesis, scales = "free", 
          ...
          ggplot(get_data_plot(results_cont_diff) %>% filter(model!="zsep" & model!="zpol", hypothesis=="H1")) +
            #geom_point(aes(lambda1, reject_h02, color=as.factor(model))) +
            geom_line(aes(lambda1, reject_h02, color=as.factor(model)), size=1) +
            geom_hline(aes(yintercept = alpha), linetype = "dashed") +
            facet_grid(trend ~ hypothesis, scales = "free", 
...
ggsave("figures_transposed/cont_all_diff_pow_alpha_supp_t.png", width = 7, height = 10)
```
...
ggsave("figures_transposed/cont_all_diff_bias_supp_t.png", width = 7, height = 10)
```
...
ggsave("figures_transposed/cont_all_diff_rmse_supp_t.png", width = 7, height = 10)
```
...
ggplot(response_cont_plot) +
  ...
  facet_grid(scenario ~ hypothesis, 
             labeller = labeller(hypothesis  = as_labeller(hypothesis_names),
...
ggsave("figures_transposed/cont_response_main_t.png", width = 5, height = 10)
```
