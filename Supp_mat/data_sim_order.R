#
data_sim_order <- function(K=1, mu0=0, delta, p0, OR, lambda, sigma, N1, N2, N_add, trend, trend_param, endpoint){
  N1<-round(N1)
  N2<-round(N2)
  N_add<-round(N_add)
  ...
  t1 <- rep(c(rep(0,ar1[1]),rep(1,ar1[2])),min(N1))
  t2 <- rep(c(rep(0,ar2[1]),rep(1,ar2[2]), rep(2,ar2[3])),min(c(N2,N_add)))
